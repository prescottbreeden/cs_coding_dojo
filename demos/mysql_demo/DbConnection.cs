...
namespace mysql_demo	//you can leave as is, or change to your own namespace
{
  public class DbConnector
  {
    static string server = "localhost";
    static string db = "mysql_connector"; //Change to your schema name
    static string port = "3306"; //Potentially 8889
    static string user = "trashpanda";
    static string pass = "rubberbabybuggybumpers";
